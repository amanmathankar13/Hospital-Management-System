            ...
            <Table striped withRowBorders={false} stripedColor='primary.1' verticalSpacing={'md'}>
                <Table.Tbody className='[&>tr]:!mb-3 [&_td]:!w-1/2'>
                    ...
                    <Table.Tr>
                        ...
                        </Table.Td>:<Table.Td className='text-xl'>{profile.allergies?profile.allergies:"-"}</Table.Td>}
                    </Table.Tr>
                    <Table.Tr>
                        ...
                        </Table.Td>:<Table.Td className='text-xl'>{profile.chronicDisease?profile.chronicDisease: "-"}</Table.Td>}
                    </Table.Tr>
                </Table.Tbody>
            </Table>
        </div>
