...
import { IconCalendarCheck, IconCannabis, IconLayoutDashboard,  IconUser} from '@tabler/icons-react'
...
const links=[
    {
        name:"Dashboard", url:"/patient/dashboard", icon:<IconLayoutDashboard stroke={1.5}/>
    },
    {
