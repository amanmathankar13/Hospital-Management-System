...
const Profile = () => {
    ...
    const form = useForm({
        ...
        validate: {
            ...
            licenseNumber: (value:any)=> !value ? "Identity Number is required" : undefined,
        },
    });
    const handleEdit=()=>{
            ...
            <Table striped withRowBorders={false} stripedColor='primary.1' verticalSpacing={'md'}>
                <Table.Tbody className='[&>tr]:!mb-3 [&_td]:!w-1/2'>
                    ...
                    <Table.Tr>
                        ...
                        {edit?<Table.Td className='text-xl'><TextInput {...form.getInputProps("licenseNumber")} placeholder='License number'/>
                    ...
                    <Table.Tr>
                        ...
                        {edit?<Table.Td className='text-xl'><Select {...form.getInputProps("specialization")} data={doctorSpecializations} placeholder='Specialization'/>
                    ...
                    <Table.Tr>
                        ...
                        {edit?<Table.Td className='text-xl'><Select {...form.getInputProps("department")} data={doctorDepartments} placeholder='Department'/>
                    ...
                    <Table.Tr>
                        ...
                        {edit?<Table.Td className='text-xl'><NumberInput {...form.getInputProps("experience")} placeholder='Experience' hideControls max={50} clampBehavior='strict'/>
                        </Table.Td>:<Table.Td className='text-xl'>{profile.experience || "-"}{profile.experience? " years" : ""}</Table.Td>}
                    </Table.Tr>
                </Table.Tbody>
            </Table>
        </div>
